...
namespace winrt::ExamPen::implementation
{
    struct MainWindow : MainWindowT<MainWindow>
    {
        ...
        void OpenColor_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
        void CloseColor_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
    };
}

namespace winrt::ExamPen::factory_implementation
{
